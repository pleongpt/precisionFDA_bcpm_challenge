...
===========
$ ./p1sc2_model.py -h
usage: p1sc2_model.py [-h] [-block] [-phenotype {0,1}]
                      [-m {log_reg,elastic,lin_SVM,rbf_SVM,RF,xgboost,classifiers_only,soft_voting,all}]
                      [-bagging {0,1}] [-smote {0,1}] [-predict]
                      [-dna_CN_predict DNA_CN_PREDICT]
...
optional arguments:
  ...
  -dna_CN_predict DNA_CN_PREDICT
                        Specify the input DNA CN filename for generating a
                        prediction.
  -pheno_predict PHENO_PREDICT
...
# Bagging and SMOTE are enabled.  Phenotype data is included.
# Log: p1sc2_classifiers_only_bagging_1_smote_1_phenotype1.txt

p1sc2_model.py -m classifiers_only -bagging 1 -smote 1 -phenotype 1

# To generate model for soft_voting.
# Bagging and SMOTE are enabled.  Phenotype data is included.
# Log: p1sc2_soft_voting_bagging_1_smote_1_phenotype1.txt

p1sc2_model.py -m soft_voting -bagging 1 -smote 1 -phenotype 1
...
# rna_test.tsv and pheno_test.tsv under the data folder.
# Log: p1sc2_soft_voting_predict.txt

p1sc2_model.py -m soft_voting -predict -dna_CN_predict ./data/dna_CN_test.tsv -pheno_predict ./data/pheno_test.tsv

# Use the xgboost model to predict the survival status based on a
# set of RNA and phenotype test data. For example: Test data files 
# rna_test.tsv and pheno_test.tsv under the data folder.
# Log: p1sc2_xgboost_predict.txt

p1sc2_model.py -m xgboost -predict -dna_CN_predict ./data/dna_CN_test.tsv -pheno_predict ./data/pheno_test.tsv
