...
optional arguments:
  ...
  -rna_predict RNA_PREDICT
                        Specify the input RNA filename for generating a
                        prediction.
  -pheno_predict PHENO_PREDICT
...
# Log: p1sc1_classifiers_only_bagging_1_smote_1_phenotype1.txt

p1sc1_model.py -m classifiers_only -bagging 1 -smote 1 -phenotype 1

# To generate model for soft_voting.
# Bagging and SMOTE are enabled.  Phenotype data is included.
# Log: p1sc1_soft_voting_bagging_1_smote_1_phenotype1.txt

p1sc1_model.py -m soft_voting -bagging 1 -smote 1 -phenotype 1
...
# Log: p1sc1_soft_voting_predict.txt

p1sc1_model.py -m soft_voting -predict -rna_predict ./data/rna_test.tsv -pheno_predict ./data/pheno_test.tsv

# Use the xgboost model to predict the survival status based on a
# set of RNA and phenotype test data. For example: Test data files 
# rna_test.tsv and pheno_test.tsv under the data folder.
# Log: p1sc1_xgboost_predict.txt

p1sc1_model.py -m xgboost -predict -rna_predict ./data/rna_test.tsv -pheno_predict ./data/pheno_test.tsv
